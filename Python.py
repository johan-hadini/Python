...
''')
print('[+] اختار :')
print('[+] بلاغ في نفس الوقت اكتب رقم - 1')
print('[+] تختار من نفسك البلاغ اكتب رقم - 2')
a5tar = input('[+] اكتب الرقم ==> : ')
if a5tar == '1':
    time.sleep(1)
    print('''
[+] النوع الاول - بلاغ عادي :
[+] النوع الثاني - بلاغ كراهيه :
[+] النوع الثالث - بلاغ انتحار :
''')
    time.sleep(1)
    print('[!] سيقوم البوت بعمل بلاغات على جميع البلاغات التي فوق المتوفره :')
    time.sleep(1)
    print("")
    id1 = input('[+] ادخل يوزر الشخص الي بتبلغ عليه ==> : ')
    print('[+] بداء الابلاغ :')
    ...
    while True:
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نشكرك على ملاحظاتك"},"errMsg":"نشكرك على ملاحظاتك"}' in req1:
            print('[+] تم الابلاغ في النوع - عادي')
        else:
            print('[-] حدث خطاء في الابلاغ في النوع - عادي')
        time.sleep(3)
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نشكرك على ملاحظاتك"},"errMsg":"نشكرك على ملاحظاتك"}' in req2:
            print('[+] تم الابلاغ في النوع - كراهي')
        else:
            print('[-] حدث حطاء في الابلاغ في النوع - كراهي')
        time.sleep(3)
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نشكرك على ملاحظاتك"},"errMsg":"نشكرك على ملاحظاتك"}' in req3:
            print('[+] تم الابلاغ في النوع - انتحار')
        else:
            print('[-] حدث حطاء في الابلاغ في النوع - انتحار')
if a5tar == '2':
    print('''
[+] النوع الاول - بلاغ عادي اكتب رقم [1]
[+] النوع الثاني - بلاغ كراهيه اكتب رقم [2]
[+] النوع الثالث - بلاغ انتحار اكتب رقم [3]
''')
a5tar2 = input('اكتب الرقم ==> : ')
if a5tar2 == '1':
    username = input('[+] ادخل يوزر الشخص الي بتبلغ عليه ==> : ')
    ...
    while True:
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نشكرك على ملاحظاتك"},"errMsg":"نشكرك على ملاحظاتك"}' in req5:
            ...
            print('[-] حدث خطاء في الابلاغ')
if a5tar2 == '2':
    username2 = input('[+] ادخل يوزر الشخص الي بتبلغ عليه ==> : ')
    ...
    while True:
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نشكرك على ملاحظاتك"},"errMsg":"نشكرك على ملاحظاتك"}' in req6:
            ...
            print('[-] حدث حطاء في الابلاغ')
if a5tar2 == '3':
    username3 = input('[+] ادخل يوزر الشخص الي بتبلغ عليه ==> : ')
